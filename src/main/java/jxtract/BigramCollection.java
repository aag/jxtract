...
public class BigramCollection {
	...
	private class Bigram implements Comparable {
		 ...
		 * 
		 * @param wi_
		 *            The second word in the Bigram. The first is defined by the
		 ...
		 * 
		 * @param k1
		 *            The threshhold above which which distances are considered
		 ...
		 * 
		 * @param obj_
		 *            The thing to compare this Bigram to.
